...
function pvtShow() {
    var checkBox = document.getElementById("PVT");
    var text = document.getElementById("BDPVT");
    if (checkBox.checked == true){
        BDPVT.style.display = "block";
    } else {
        BDPVT.style.display = "none";
    }
}

function publicShow() {
    var checkBox = document.getElementById("PUBLIC");
    var text = document.getElementById("BDPUBLIC");
    if (checkBox.checked == true){
        BDPUBLIC.style.display = "block";
    } else {
        BDPUBLIC.style.display = "none";
    }
}
...
//---------------------------------------------------------------------------------------
// This is code for opening the text-area under Lat-Long on Re-route and Barrier Others
...
const checkbox2 = document.getElementById('BDV36');
...
const checkbox3 = document.getElementById('BDV37');
...
function copyAndClear() {
    ...
    //For Private Imageries Checkboxes
    ...
    }pvtShow();//To close the collapsible checkbox


    //For Public OSM Imageries Checkboxes
    ...
    }publicShow();//To close the collapsible checkbox
    ...
    if (document.getElementById('OTHER_OPTIONS').checked) {
        ...
        if (document.getElementById('BDV34').checked) {
            finalText += document.getElementById('BDV34').value + ', ';
            document.getElementById('BDV34').checked = false;
        }
        if (document.getElementById('BDV35').checked) {
            finalText += document.getElementById('BDV35').value + ', ';
            document.getElementById('BDV35').checked = false;
        }
        if (document.getElementById('BDV36').checked) {
            ...
            document.getElementById('BDV36').checked = false;
        }
        if (document.getElementById('BDV37').checked) {
            finalText += '@HGV: ';
            finalText += document.getElementById('@HGV').value + ', ';
            document.getElementById('@HGV').value='';
            document.getElementById('BDV37').checked = false;
        }
